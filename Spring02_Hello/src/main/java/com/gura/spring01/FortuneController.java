...
public class FortuneController {
	...
	public String fortune(HttpServletRequest request) {//return type 은 String, 메소드명은 마음대로 지을 수 있다.
		
		/*
		 * 4. 메소드 안에서 필요한 객체가 있으면
		 * ex) HttpServletRequest, HttpSession ...
		 * 메소드의 인자로 선언만 하면 알아서 해당 객체의 참조값이 자동으로 전달된다.
		 */
...
/*
	...
	결과는 "/WEB-INF/views/fortune.jsp" 가 jsp 페이지의 위치가 된다.
	그러므로 해당 위치를 찾아서 jsp 파일을 만들어서 응답하면 된다.
	
	***return 시 내부적으로 알아서 forward 이동을 해준다. (default forward)
*/